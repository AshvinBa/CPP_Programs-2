...
void deleatfromhead(Node *&tail, Node *&head)
{
	if(head==NULL)
    {
...
void deleatfromtail(Node *&tail, Node *&head)
{
	Node *temp = tail;
    if(head==NULL)
    {
...
int main()
{
    ...
    do
    {
        ...
        cout << "\n\t7) Search Element in Link list.";
        cout << "\n\t8) Display the Link list.";
        cout << "\n\t9) Exit.";
        cout << "\n\tEnter Your choise: ";
        cin >> s;
        switch (s)
