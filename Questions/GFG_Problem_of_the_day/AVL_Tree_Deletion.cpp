...
int inorderPredecessor(Node* head)
{
    if(!head)
    return -1;
...
Node* deleteNode(Node* root, int data)
{
    ...
    else
    {
        ...
        {
            int inorderPredecessor1=inorderPredecessor(root->right);
            root->data=inorderPredecessor1;
            root->right=deleteNode(root->right,inorderPredecessor1);
        }
    }
...
/*
Enter the number: 4 2 6 1 3 5 7
Enter the limit: 4
