...
class Solution{
    ...
    bool isSimilar(struct Node *root1,struct Node *root2)
    {
        ...
        bool a=isSimilar(root1->left,root2->left) && isSimilar(root1->right,root2->right);
        
        bool b=isSimilar(root1->left,root2->right) && isSimilar(root1->right,root2->left);
